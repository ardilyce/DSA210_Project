...
def train_model(X_train, y_train, use_smote=False):
    ...
    #Train a Random Forest Classifier, optionally using SMOTE for oversampling.
...
if __name__ == "__main__":
    ...
    model = train_model(X_train, y_train, use_smote=False)  # Set use_smote=True to enable SMOTE
